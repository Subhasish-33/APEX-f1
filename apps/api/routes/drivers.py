...
@governed_cache(domain="drivers", tier=CacheTier.WARM)
...
@governed_cache(domain="driver_ref", tier=CacheTier.STATIC)
...
@governed_cache(domain="driver_career", tier=CacheTier.STATIC)
